      ...
      <div className="modal-main-container">
        <div className="main-left-container">
          ...
          <div className="title-container">
            <img src={logo_roxo} alt="Logo Flush" />
            <h1 className="title-choice">Bem vindo ao Flush</h1>
          </div>
          ...
          <div className="containerOptions">
            ...
            >
              ...
              <div className="description">
                ...
                <p>
                  Vou usar o Flush para organizar meus projetos e/ou times.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="description">
                ...
                <p>
                  A empresa onde trabalho usa Flush e eu possuo um código de
                  acesso.
                </p>
              </div>
            </div>
